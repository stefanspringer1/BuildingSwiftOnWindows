...
4. Scroll down to the "Sources" section. You can find the commit numbers for the different repositories under "Version". (For commits, only the first eight digits are displayed, usually that is enough, see next section. The whole commit number is the last part of the URL of that link.)
